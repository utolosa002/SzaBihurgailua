...
public class MainActivity extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(2, 2, 1,  R.string.idata).setIcon(
				android.R.drawable.ic_menu_info_details);
		menu.add(3, 3, 2,  R.string.igaia).setIcon(android.R.drawable.ic_menu_delete);
		menu.add(4, 4, 3,  R.string.idev).setIcon(android.R.drawable.ic_menu_day);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 1:
			Toast.makeText(this,R.string.kodea,
		...
		case 3:
			...
			break;
		case 4:
			Toast.makeText(this,R.string.dev ,
					Toast.LENGTH_LONG).show();
			break;
		}
